...
class officeResponse extends React.Component {
  constructor() {
    super();
    this.state = {
      title: "Office Response Demographic",
      items: [],
      tableHeader: ['Region', 'Total Client', 'Overall'],
  ...
  handleGenerate = (e) => {
    ...
    axios({
      method: "POST",
      url: process.env.REACT_APP_API_URL + "GetDemographicRegionList",
      data: (newObject),
      headers: { 'Content-Type': 'application/json' }
    }).then(resp => {
